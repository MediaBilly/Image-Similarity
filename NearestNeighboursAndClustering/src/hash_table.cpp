...
Hash_Table::Hash_Table(int k, int w, int d, int buckets) {
    ...
    // Create buckets
    this->table = new std::list<Image<Pixel8Bit>*>[buckets]; 

    // Initialize hash function
    this->hash_function = new Hash_Function(k,w,d);
}

unsigned long Hash_Table::g(Image<Pixel8Bit> *image) {
    unsigned long g = 0;
...
bool Hash_Table::insert(Image<Pixel8Bit> *image) {
...
std::list<Image<Pixel8Bit>*> Hash_Table::getBucketImages(Image<Pixel8Bit>* q) {
